...
Cette etape ne sert pas a modifier les donnees. Elle donne surtout un controle
visuel rapide de la sequence RGB qui a ete extraite du bag.
"""
import argparse
...
def frames_to_video(seq_dir, fps="auto"):
    ...
    # Cela respecte mieux les donnees qu'une valeur fixe imposee partout.
