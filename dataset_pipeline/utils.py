...
def open_bag(bag_path):
    ...
    # AnyReader permet de lire les bags ROS1 sans lancer un environnement ROS complet qui étais assez compliqué à mettre en place durant mon stage.
...
def find_topic(reader, kind, requested=None):
    ...
    # Pour le RGB, on evite aussi les topics thermiques, depth ou DVS par sécurité.
